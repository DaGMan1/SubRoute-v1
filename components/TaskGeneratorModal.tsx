...
export const TaskGeneratorModal: React.FC<TaskGeneratorModalProps> = ({
  ...
  return (
    ...
    >
      <div 
        className="bg-white rounded-lg shadow-2xl w-full max-w-3xl max-h-[90vh] flex flex-col overflow-hidden m-4"
        ...
        <div className="p-6 md:p-8 overflow-y-auto">
          {isLoading ? (
            <div className="flex flex-col items-center justify-center h-64">
                ...
                <p className="mt-4 text-brand-gray-600">Gemini is thinking...</p>
            </div>
          ) : (
